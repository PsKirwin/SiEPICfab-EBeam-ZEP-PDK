...
class ebeam_taper_strip_rib(pya.PCellDeclarationHelper):
    ...
    copied from ebeam pdk to zep pdk by pkirwin 2026 Jan
    """
    def __init__(self):
        ...
        self.param("siriblayer", self.TypeLayer, "Si Layer", default=TECHNOLOGY["Si_core"])
        self.param(
            "sislablayer",
            self.TypeLayer,
            "Si slab Layer",
            default=TECHNOLOGY["Si_slab"],
        )
        self.param(
            "sicladlayer",
            self.TypeLayer,
    ...
    def produce(self, layout, layers, parameters, cell):
        ...
        LayerSi = self.siriblayer
        LayerSiN = self.siriblayer_layer
        LayerSi90 = self.sislablayer
        LayerSi90N = self.sislablayer_layer
        LayerSiclad = ly.layer(self.sicladlayer)
